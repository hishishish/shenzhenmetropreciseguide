...
// Line 5 towards Chiwan (赤湾)
  { lineId: "5", direction: "赤湾", station: "前湾", targetLineId: "9", targetDirection: "文锦", method: "节点", time: "1分钟", cars: ["5", "3"], doors: ["9", "20"], notes: "6号车为车头", doorSide: "左侧" },
  ...
  { lineId: "5", direction: "赤湾", station: "布吉", targetLineId: "3", targetDirection: "福保", method: "天地", time: "5分钟", cars: ["3"], doors: ["20"], notes: "6号车为车头", doorSide: "左侧" },
  ...
  { lineId: "5", direction: "赤湾", station: "赤湾", targetLineId: "2_8", targetDirection: "溪涌", method: "站厅", time: "2分钟", cars: ["4", "3"], doors: ["14", "18"], notes: "6号车为车头" },
  { lineId: "5", direction: "赤湾", station: "宝安中心", targetLineId: "1", targetDirection: "罗湖", method: "节点", time: "1分钟", cars: ["4", "3"], doors: ["14", "17"], notes: "6号车为车头", doorSide: "右侧" },
  { lineId: "5", direction: "赤湾", station: "西丽", targetLineId: "7", targetDirection: "太安", method: "节点", time: "1分钟", cars: ["2"], doors: ["25"], notes: "6号车为车头", doorSide: "右侧" },
  { lineId: "5", direction: "赤湾", station: "西丽", targetLineId: "7", targetDirection: "深大丽湖", method: "节点", time: "1分钟", cars: ["1"], doors: ["28"], notes: "6号车为车头", doorSide: "右侧" },
  { lineId: "5", direction: "赤湾", station: "深圳北站", targetLineId: "4", targetDirection: "牛湖", method: "天地", time: "5分钟", cars: ["6"], doors: ["5"], notes: "6号车为车头", doorSide: "右侧" },
  { lineId: "5", direction: "赤湾", station: "深圳北站", targetLineId: "6", targetDirection: "松岗", method: "天地", time: "5分钟", cars: ["6"], doors: ["5"], notes: "6号车为车头", doorSide: "右侧" },
  { lineId: "5", direction: "赤湾", station: "黄贝岭", targetLineId: "2_8", targetDirection: "溪涌", method: "同台", time: "1分钟", cars: ["ANY"], doors: ["ANY"], notes: "6号车为车头", doorSide: "右侧" },
  { lineId: "5", direction: "赤湾", station: "黄贝岭", targetLineId: "2_8", targetDirection: "赤湾", method: "站厅", time: "2分钟", cars: ["ANY"], doors: ["ANY"], notes: "6号车为车头", doorSide: "右侧" },

// Line 5 towards Dajuyuan (大剧院)
  { lineId: "5", direction: "大剧院", station: "前湾", targetLineId: "9", targetDirection: "文锦", method: "节点", time: "1分钟", cars: ["3", "5"], doors: ["11", "22"], notes: "1号车为车头", doorSide: "左侧" },
  ...
  { lineId: "5", direction: "大剧院", station: "布吉", targetLineId: "3", targetDirection: "福保", method: "天地", time: "5分钟", cars: ["3"], doors: ["11"], notes: "1号车为车头", doorSide: "左侧" },
  ...
  { lineId: "5", direction: "大剧院", station: "宝安中心", targetLineId: "1", targetDirection: "罗湖", method: "节点", time: "1分钟", cars: ["3", "4"], doors: ["14", "17"], notes: "1号车为车头", doorSide: "右侧" },
  { lineId: "5", direction: "大剧院", station: "深圳北站", targetLineId: "4", targetDirection: "牛湖", method: "天地", time: "5分钟", cars: ["6"], doors: ["30"], notes: "1号车为车头", doorSide: "右侧" },
  { lineId: "5", direction: "大剧院", station: "深圳北站", targetLineId: "6", targetDirection: "松岗", method: "天地", time: "5分钟", cars: ["6"], doors: ["30"], notes: "1号车为车头", doorSide: "右侧" },
  { lineId: "5", direction: "大剧院", station: "西丽", targetLineId: "7", targetDirection: "太安", method: "节点", time: "1分钟", cars: ["2"], doors: ["7"], notes: "1号车为车头", doorSide: "右侧" },
  { lineId: "5", direction: "大剧院", station: "西丽", targetLineId: "7", targetDirection: "深大丽湖", method: "节点", time: "1分钟", cars: ["1"], doors: ["2"], notes: "1号车为车头", doorSide: "右侧" },
  { lineId: "5", direction: "大剧院", station: "黄贝岭", targetLineId: "2_8", targetDirection: "溪涌", method: "站厅", time: "2分钟", cars: ["ANY"], doors: ["ANY"], notes: "1号车为车头", doorSide: "右侧" },
  { lineId: "5", direction: "大剧院", station: "黄贝岭", targetLineId: "2_8", targetDirection: "赤湾", method: "同台", time: "1分钟", cars: ["ANY"], doors: ["ANY"], notes: "1号车为车头", doorSide: "右侧" },
  { lineId: "5", direction: "大剧院", station: "大剧院", targetLineId: "1", targetDirection: "罗湖", method: "通道", time: "3分钟", cars: ["2"], doors: ["7"], notes: "1号车为车头", doorSide: "右侧" },
  { lineId: "5", direction: "大剧院", station: "大剧院", targetLineId: "2_8", targetDirection: "溪涌", method: "通道", time: "3分钟", cars: ["2"], doors: ["7"], notes: "1号车为车头", doorSide: "右侧" },

// Line 1 towards Luohu (罗湖)
  { lineId: "1", direction: "罗湖", station: "宝安中心", targetLineId: "5", targetDirection: "大剧院", method: "节点", time: "1分钟", cars: ["3"], doors: ["11"], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "1", direction: "罗湖", station: "宝安中心", targetLineId: "5", targetDirection: "赤湾", method: "节点", time: "1分钟", cars: ["6"], doors: ["27"], notes: "1号车为车头", doorSide: "左侧" },
  ...
  { lineId: "1", direction: "罗湖", station: "世界之窗", targetLineId: "2_8", targetDirection: "溪涌", method: "节点", time: "1分钟", cars: ["3"], doors: ["11"], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "1", direction: "罗湖", station: "世界之窗", targetLineId: "2_8", targetDirection: "赤湾", method: "节点", time: "1分钟", cars: ["6"], doors: ["27"], notes: "1号车为车头", doorSide: "左侧" },
...
// Line 1 towards Airport East (机场东)
  ...
  { lineId: "1", direction: "机场东", station: "世界之窗", targetLineId: "2_8", targetDirection: "溪涌", method: "节点", time: "1分钟", cars: ["3"], doors: ["20"], notes: "6号车为车头", doorSide: "左侧" },
  { lineId: "1", direction: "机场东", station: "世界之窗", targetLineId: "2_8", targetDirection: "赤湾", method: "节点", time: "1分钟", cars: ["6"], doors: ["4"], notes: "6号车为车头", doorSide: "左侧" },
  ...
  { lineId: "1", direction: "机场东", station: "机场东", targetLineId: "12", targetDirection: "松岗", method: "天地", time: "5分钟", cars: ["2"], doors: ["23"], notes: "6号车为车头", doorSide: "右侧" },
  { lineId: "1", direction: "机场东", station: "老街", targetLineId: "3", targetDirection: "福保", method: "同台", time: "1分钟", cars: ["3-6"], doors: ["1-3", "6-9", "15-17"], notes: "6号车为车头", doorSide: "右侧" },
  { lineId: "1", direction: "机场东", station: "老街", targetLineId: "3", targetDirection: "坪地六联", method: "节点", time: "2分钟", cars: ["6"], doors: ["3-4"], notes: "6号车为车头", doorSide: "右侧" },

// Line 11 towards Bitou (碧头)
  { lineId: "11", direction: "碧头", station: "松岗", targetLineId: "6", targetDirection: "科学馆", method: "节点", time: "1分钟", cars: ["3"], doors: ["29"], notes: "8号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "碧头", station: "松岗", targetLineId: "12", targetDirection: "松岗", method: "通道", time: "4分钟", cars: ["5"], doors: ["17"], notes: "8号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "碧头", station: "福永", targetLineId: "12", targetDirection: "松岗", method: "通道", time: "6分钟", cars: ["3"], doors: ["26"], notes: "8号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "碧头", station: "机场北", targetLineId: "20", targetDirection: "会展城", method: "站厅", time: "2分钟", cars: ["4"], doors: ["21"], notes: "8号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "碧头", station: "前海湾", targetLineId: "1", targetDirection: "罗湖", method: "站厅", time: "3分钟", cars: ["2", "3", "4", "6", "7（商务号车）"], doors: ["32", "26", "21", "15", "10"], notes: "8号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "碧头", station: "前海湾", targetLineId: "5", targetDirection: "赤湾", method: "站厅", time: "2分钟", cars: ["2", "3", "4", "6", "7（商务号车）"], doors: ["32", "26", "21", "15", "10"], notes: "8号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "碧头", station: "南山", targetLineId: "12", targetDirection: "松岗", method: "节点", time: "1分钟", cars: ["3"], doors: ["29"], notes: "8号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "碧头", station: "南山", targetLineId: "12", targetDirection: "左炮台东", method: "节点", time: "1分钟", cars: ["5"], doors: ["19"], notes: "8号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "碧头", station: "后海", targetLineId: "2_8", targetDirection: "赤湾", method: "通道", time: "5分钟", cars: ["7（商务号车）"], doors: ["7"], notes: "8号车为车头", doorSide: "左侧" },
  ...
  { lineId: "11", direction: "碧头", station: "红树湾南", targetLineId: "9", targetDirection: "前湾", method: "同台", time: "1分钟", cars: ["1-6"], doors: ["ANY"], notes: "8号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "碧头", station: "红树湾南", targetLineId: "9", targetDirection: "文锦", method: "站厅", time: "2分钟", cars: ["1-6"], doors: ["ANY"], notes: "8号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "碧头", station: "车公庙", targetLineId: "1", targetDirection: "罗湖", method: "通道", time: "2分钟", cars: ["5"], doors: ["19"], notes: "8号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "碧头", station: "车公庙", targetLineId: "7", targetDirection: "太安", method: "通道", time: "4分钟", cars: ["2"], doors: ["35"], notes: "8号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "碧头", station: "车公庙", targetLineId: "9", targetDirection: "文锦", method: "通道", time: "4分钟", cars: ["2"], doors: ["35"], notes: "8号车为车头", doorSide: "左侧" },
  ...
  { lineId: "11", direction: "碧头", station: "福田", targetLineId: "3", targetDirection: "福保", method: "节点", time: "1分钟", cars: ["8（商务号车）"], doors: ["5"], notes: "8号车为车头", doorSide: "左侧" },
  ...
  { lineId: "11", direction: "碧头", station: "岗厦北", targetLineId: "2_8", targetDirection: "溪涌", method: "通道", time: "4分钟", cars: ["1"], doors: ["36"], notes: "8号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "碧头", station: "岗厦北", targetLineId: "10", targetDirection: "福田口岸", method: "节点", time: "1分钟", cars: ["7（商务号车）"], doors: ["9"], notes: "8号车为车头", doorSide: "左侧" },
  ...
  { lineId: "11", direction: "碧头", station: "华强南", targetLineId: "7", targetDirection: "深大丽湖", method: "通道", time: "3分钟", cars: ["6"], doors: ["11"], notes: "8号车为车头", doorSide: "左侧" },

  // Line 11 towards Hongling South (红岭南)
  { lineId: "11", direction: "红岭南", station: "松岗", targetLineId: "6", targetDirection: "科学馆", method: "节点", time: "1分钟", cars: ["3"], doors: ["12"], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "红岭南", station: "松岗", targetLineId: "12", targetDirection: "松岗", method: "通道", time: "4分钟", cars: ["5"], doors: ["24"], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "红岭南", station: "福永", targetLineId: "12", targetDirection: "松岗", method: "通道", time: "6分钟", cars: ["3"], doors: ["15"], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "红岭南", station: "机场北", targetLineId: "20", targetDirection: "会展城", method: "站厅", time: "2分钟", cars: ["4"], doors: ["20"], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "红岭南", station: "前海湾", targetLineId: "1", targetDirection: "罗湖", method: "站厅", time: "3分钟", cars: ["2", "3", "4", "6", "7（商务号车）"], doors: ["31", "26", "20", "15", "9"], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "红岭南", station: "前海湾", targetLineId: "5", targetDirection: "赤湾", method: "站厅", time: "2分钟", cars: ["2", "3", "4", "6", "7（商务号车）"], doors: ["31", "26", "20", "15", "9"], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "红岭南", station: "南山", targetLineId: "12", targetDirection: "松岗", method: "节点", time: "1分钟", cars: ["3"], doors: ["12"], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "红岭南", station: "南山", targetLineId: "12", targetDirection: "左炮台东", method: "节点", time: "1分钟", cars: ["5"], doors: ["22"], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "红岭南", station: "后海", targetLineId: "2_8", targetDirection: "赤湾", method: "通道", time: "5分钟", cars: ["7（商务号车）"], doors: ["34"], notes: "1号车为车头", doorSide: "左侧" },
  ...
  { lineId: "11", direction: "红岭南", station: "红树湾南", targetLineId: "9", targetDirection: "文锦", method: "同台", time: "1分钟", cars: ["1-6"], doors: ["ANY"], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "红岭南", station: "红树湾南", targetLineId: "9", targetDirection: "前湾", method: "站厅", time: "2分钟", cars: ["1-6"], doors: ["ANY"], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "红岭南", station: "车公庙", targetLineId: "1", targetDirection: "罗湖", method: "通道", time: "2分钟", cars: ["5"], doors: ["22"], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "红岭南", station: "车公庙", targetLineId: "7", targetDirection: "深大丽湖", method: "通道", time: "4分钟", cars: ["2"], doors: ["6"], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "红岭南", station: "车公庙", targetLineId: "9", targetDirection: "文锦", method: "通道", time: "4分钟", cars: ["2"], doors: ["6"], notes: "1号车为车头", doorSide: "左侧" },
  ...
  { lineId: "11", direction: "红岭南", station: "福田", targetLineId: "3", targetDirection: "福保", method: "节点", time: "1分钟", cars: ["8（商务号车）"], doors: ["36"], notes: "1号车为车头", doorSide: "左侧" },
  ...
  { lineId: "11", direction: "红岭南", station: "岗厦北", targetLineId: "2_8", targetDirection: "溪涌", method: "通道", time: "4分钟", cars: ["1"], doors: ["5"], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "红岭南", station: "岗厦北", targetLineId: "10", targetDirection: "福田口岸", method: "节点", time: "1分钟", cars: ["7（商务号车）"], doors: ["32"], notes: "1号车为车头", doorSide: "左侧" },
  ...
  { lineId: "11", direction: "红岭南", station: "岗厦北", targetLineId: "14", targetDirection: "沙田", method: "站厅", time: "1分钟", cars: ["ANY"], doors: ["ANY"], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "11", direction: "红岭南", station: "华强南", targetLineId: "7", targetDirection: "深大丽湖", method: "通道", time: "3分钟", cars: ["6"], doors: ["30"], notes: "1号车为车头", doorSide: "左侧" },
  ...
  { lineId: "13", direction: "深圳湾口岸", station: "粤海门", targetLineId: "9", targetDirection: "文锦", method: "节点", time: "1分钟", cars: ["1"], doors: ["38"], notes: "8号车为车头", doorSide: "左侧" },
  { lineId: "13", direction: "深圳湾口岸", station: "科苑", targetLineId: "2_8", targetDirection: "赤湾", method: "节点", time: "1分钟", cars: ["1"], doors: ["40"], notes: "8号车为车头", doorSide: "左侧" },
 ...
 // Line 13 towards Shangwu (上屋)
  ...
  { lineId: "13", direction: "上屋", station: "粤海门", targetLineId: "9", targetDirection: "文锦", method: "节点", time: "1分钟", cars: ["1"], doors: ["3"], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "13", direction: "上屋", station: "科苑", targetLineId: "2_8", targetDirection: "赤湾", method: "节点", time: "1分钟", cars: ["1"], doors: ["1"], notes: "1号车为车头", doorSide: "左侧" },
  ...
  { lineId: "13", direction: "上屋", station: "上屋", targetLineId: "6", targetDirection: "科学馆", method: "天地", time: "5分钟", cars: ["3"], doors: ["14"], notes: "1号车为车头", doorSide: "右侧" },
 ...
 // Line 12 towards Zuopaotai East (左炮台东)
  ...
  { lineId: "12", direction: "左炮台东", station: "海上世界", targetLineId: "2_8", targetDirection: "溪涌", method: "通道", time: "3分钟", cars: ['2', '5'], doors: ['8', '23'], notes: "1号车为车头", doorSide: "左侧" },
 ...
 // Line 12 towards Songgang (松岗)
  ...
  { lineId: "12", direction: "松岗", station: "海上世界", targetLineId: "2_8", targetDirection: "溪涌", method: "通道", time: "3分钟", cars: ['2', '5'], doors: ['8', '23'], notes: "6号车为车头", doorSide: "左侧" },
 ...
 // Line 10 towards Futian Checkpoint (福田口岸)
  ...
  { lineId: "10", direction: "福田口岸", station: "岗厦北", targetLineId: "2_8", targetDirection: "溪涌", method: "通道", time: "5分钟", cars: ['2'], doors: ['35'], notes: "8号车为车头", doorSide: "右侧" },
 ...
 // Line 10 towards Shuangyong Street (双拥街)
  ...
  { lineId: "10", direction: "双拥街", station: "岗厦北", targetLineId: "2_8", targetDirection: "溪涌", method: "通道", time: "5分钟", cars: ['2'], doors: ['6'], notes: "1号车为车头", doorSide: "右侧" },
 ...
 // Line 14 towards Gangxiabei (岗厦北)
  ...
  { lineId: "14", direction: "岗厦北", station: "岗厦北", targetLineId: "2_8", targetDirection: "溪涌", method: "通道", time: "4分钟", cars: ['8'], doors: ['36'], notes: "1号车为车头", doorSide: "右侧" },
 ...
 // Line 9 towards Qianwan (前湾)
  ...
  { lineId: "9", direction: "前湾", station: "景田", targetLineId: "2_8", targetDirection: "赤湾", method: "节点", time: "1分钟", cars: ['5'], doors: ['24'], notes: "1号车为车头", doorSide: "左侧" },
  { lineId: "9", direction: "前湾", station: "景田", targetLineId: "2_8", targetDirection: "溪涌", method: "节点", time: "1分钟", cars: ['2'], doors: ['7'], notes: "1号车为车头", doorSide: "左侧" },
 ...
 // Line 9 towards Wenjin (文锦)
  ...
  { lineId: "9", direction: "文锦", station: "景田", targetLineId: "2_8", targetDirection: "赤湾", method: "节点", time: "1分钟", cars: ['5'], doors: ['7'], notes: "6号车为车头", doorSide: "左侧" },
  { lineId: "9", direction: "文锦", station: "景田", targetLineId: "2_8", targetDirection: "溪涌", method: "节点", time: "1分钟", cars: ['2'], doors: ['24'], notes: "6号车为车头", doorSide: "左侧" },
 ...
 // Line 7 towards Shenda Lihu (深大丽湖)
  ...
  { lineId: "7", direction: "深大丽湖", station: "华强北", targetLineId: "2_8", targetDirection: "溪涌", method: "通道", time: "5分钟", cars: ['5'], doors: ['25'], notes: "1号车为车头", doorSide: "左侧" },
  ...
  { lineId: "7", direction: "深大丽湖", station: "安托山", targetLineId: "2_8", targetDirection: "溪涌", method: "节点", time: "1分钟", cars: ['3'], doors: ['13'], notes: "1号车为车头", doorSide: "右侧" },
 ...
 // Line 7 towards Tai'an (太安)
  ...
  { lineId: "7", direction: "太安", station: "华强北", targetLineId: "2_8", targetDirection: "溪涌", method: "通道", time: "5分钟", cars: ['5'], doors: ['6'], notes: "6号车为车头", doorSide: "左侧" },
  ...
  { lineId: "7", direction: "太安", station: "安托山", targetLineId: "2_8", targetDirection: "溪涌", method: "节点", time: "1分钟", cars: ['3'], doors: ['18'], notes: "6号车为车头", doorSide: "右侧" },
 ...
 // Line 4 towards Futian Checkpoint (福田口岸)
  ...
  { lineId: "4", direction: "福田口岸", station: "市民中心", targetLineId: "2_8", targetDirection: "溪涌", method: "通道", time: "4分钟", cars: ['5'], doors: ['7'], notes: "6号车为车头", doorSide: "右侧" },
 ...
 // Line 4 towards Niuhu (牛湖)
  ...
  { lineId: "4", direction: "牛湖", station: "市民中心", targetLineId: "2_8", targetDirection: "溪涌", method: "通道", time: "4分钟", cars: ['5'], doors: ['24'], notes: "1号车为车头", doorSide: "右侧" },
 ...
 // Line 2 towards Xichong (溪涌)
  ...
  { lineId: "3", direction: "福保", station: "福田", targetLineId: "2_8", targetDirection: "溪涌", method: "节点", time: "1分钟", cars: ['2'], doors: ['17'], notes: "6号车为车头", doorSide: "右侧" },
 ...
 // Line 3 towards Pingdi Liulian (坪地六联)
  ...
  { lineId: "3", direction: "坪地六联", station: "福田", targetLineId: "2_8", targetDirection: "溪涌", method: "节点", time: "1分钟", cars: ['2'], doors: ['8'], notes: "1号车为车头", doorSide: "右侧" },
